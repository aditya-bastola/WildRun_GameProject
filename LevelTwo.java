...
public class LevelTwo extends JPanel implements KeyListener, ActionListener
{
	...
	JButton TO_LEVEL_THREE = new JButton ("");
	...
	public LevelTwo(CardLayout cardLayout, cardLayoutPanel cards)
	{
		super();
		...
		this.addComponentListener( new ComponentAdapter() {
			...
			public void componentShown( ComponentEvent e ) {
				LevelTwo.this.requestFocusInWindow();
		...
		TO_LEVEL_THREE.setSize(200,75);

		TO_LEVEL_THREE.setOpaque(false);
		TO_LEVEL_THREE.setContentAreaFilled(false);
		TO_LEVEL_THREE.setBorderPainted(false);

		this.add(TO_LEVEL_THREE);

		TO_LEVEL_THREE.addActionListener(e -> cardLayout.next(cards));
	...
	public void paintComponent (Graphics g) {
		...
		for (int i = 0 - viewX - 70 - 2700; i < 2700* 20 - viewX; i += 2700)
		{
			g.drawImage(underWater1, i, 0, 2700, 675, null);
		}
		...
		TO_LEVEL_THREE.setLocation(viewY + 900, viewY + 15);
